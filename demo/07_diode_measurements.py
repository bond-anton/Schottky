...
_, (ax1, ax2, ax3, ax4) = plt.subplots(4, sharex=True)
ax1.plot(flat_grid['z coordinate'], flat_grid['potential'], 'r-o')
ax2.plot(flat_grid['z coordinate'], flat_grid['residual error'], 'r-o')
ax3.plot(flat_grid['z coordinate'], rho, 'r-o')
