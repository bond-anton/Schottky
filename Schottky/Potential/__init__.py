...
class ChargedSphere(Field):
    ...
    def __init__(self, q, r, name='Spherical Coulomb trap', field_type='electrostatic'):
        self.r = r
        self.q = q
...
class ChargedCylinder(Field):
    ...
    def __init__(self, l, r, name='Cylindrical Coulomb trap', field_type='electrostatic'):
        self.r = r  # radius of cylinder
        self.l = l  # linear charge density
